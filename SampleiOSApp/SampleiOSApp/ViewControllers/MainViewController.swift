...
class MainViewController: UIViewController {
    ...
    @IBAction func createPasswordBtnClick(_ sender: UIButton) {
        let createPasswordViewController = self.storyboard?.instantiateViewController(withIdentifier: "CreatePasswordViewController") as! CreatePasswordViewController
